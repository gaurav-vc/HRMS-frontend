    ...
    try {
      ...
      const combined = empsList.map((emp: any) => {
        ...
        return {
          ...
          employeeId: emp.id,
          offerNumber: offer?.offer_number || `Pending Generation`,
          candidateName: `${emp.first_name || emp.firstName || ''} ${emp.last_name || emp.lastName || ''}`.trim(),
          candidateEmail: emp.email || '',
          designationName: offer?.designation_name || emp.designation_name || emp.designationName || 'N/A',
          departmentName: offer?.department_name || emp.department_name || emp.departmentName || 'N/A',
          entityName: offer?.entity_name || emp.entity_name || emp.entityName || 'N/A',
          joiningDate: offer?.joining_date || emp.doj || 'TBD',
