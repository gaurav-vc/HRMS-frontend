    ...
    <div className="p-6 space-y-6 bg-[#f9fafb] min-h-screen">
      <div>
        ...
        <p className="text-[15px] text-slate-500 mt-1">
          Manage super admin level tenant organizations
        </p>
      </div>
...
export function OrgDialog({ open, onOpenChange, data, mode, onSave }: any) {
  ...
  const fillDummy = () =>
    setForm({
      ...
      status: "Active",
      companyName: "Nexus Innovations LLC",
      entityName: "Nexus Tech",
      siteLocation: "HQ Building",
      ...
      subDomain: "nexus.peoplepulse.com",
      solutionType: "SaaS",
      solutionFor: "HR Management",
      billingTerm: "Monthly",
      rateOfBilling: "499.00",
  ...
  return (
    <div className="bg-white rounded-xl border shadow-sm flex flex-col">
        ...
        <section>
          ...
          <div className="grid grid-cols-2 gap-4 items-end">
            <div className="flex items-center space-x-2 border p-4 rounded-md h-[72px]">
              <Checkbox
                id="white_label"
                checked={form.whiteLabelEnabled || false}
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) => setForm({ ...form, solutionType: v })}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) => setForm({ ...form, billingTerm: v })}
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) => setForm({ ...form, projectDuration: v })}
              >
                <SelectTrigger>
                  <SelectValue placeholder="-- Please choose an option --" />
                </SelectTrigger>
      ...
      <div className="p-6 pt-4 border-t flex justify-end gap-2 bg-slate-50/50 rounded-b-xl">
        ...
        {mode !== "view" && <Button onClick={() => onSave(form)}>Save Organization</Button>}
      </div>
    </div>
  );
}
