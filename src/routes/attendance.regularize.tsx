        ...
        ? [
            {
              at: r.approved_at
                ...
                : new Date(r.updated_at || r.updatedAt).toLocaleString(),
              by: "Manager",
              action: r.status,
    ...
    <>
      ...
      <DataTable
        ...
        columns={[
          ...
          },
          {
            ...
            render: (r) =>
              r.managerComments ? (
                <span className="text-xs italic">"{r.managerComments}"</span>
              ) : (
                <span className="text-xs text-muted-foreground">—</span>
              ),
        ...
        actions={(r) => (
          <div className="flex justify-end gap-1">
            <Button size="sm" variant="ghost" title="History" onClick={() => setDetail(r)}>
      ...
      <Dialog open={!!acting} onOpenChange={(o) => !o && setActing(null)}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              {acting?.type === "Approved" ? "Approve request" : "Reject request"}
            </DialogTitle>
            <DialogDescription>
              {acting && (
                <>
                  {acting.row.employeeName} • {acting.row.attendanceDate} •{" "}
                  {acting.row.requestedCheckIn}–{acting.row.requestedCheckOut}
                </>
              )}
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-2">
            <Label>
              Reviewer comment{" "}
              {acting?.type === "Rejected" && <span className="text-destructive">*</span>}
            </Label>
            <Textarea
              value={comment}
      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Submit a missed-punch correction for HR approval.</DialogDescription>
          </DialogHeader>
          <div className="space-y-3">
            <div>
              ...
              >
                ...
                <SelectContent>
                  {employees.slice(0, 30).map((e: any) => (
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              {detail && (
                <>
                  {detail.employeeName} • {detail.attendanceDate}
                </>
              )}
            </DialogDescription>
          </DialogHeader>
              ...
              {detail?.history.map((h, i) => (
                <li key={i} className="flex gap-3">
                  ...
                  <div className="flex-1 text-sm">
                    ...
                    {h.comment && (
                      <div className="mt-1 p-2 rounded bg-muted text-xs italic">"{h.comment}"</div>
                    )}
                  </div>
                </li>
              ))}
